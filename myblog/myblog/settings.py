...
SECRET_KEY = 'django-insecure-l_ziv5yp8mu=a1th#wk-5&17*b5+d$g1nl9-$6#_=alpt%6o=0'
...
DATABASES = {
    ...
    'default': {
        'ENGINE' : 'django.db.backends.mysql', # mysql driver link
        'NAME' : 'myblogapp', # database name
